				...
				with Collapsible(classes="collapse_left_bot", title="Denoiser Settings", collapsed=True):
					with Horizontal(classes="container_t2"):
						...
						with VerticalScroll(classes="container_t1"):
							...
							with Horizontal(classes="left_settings_horizontal_container"):
								with VerticalScroll(classes="container_t1"):
								...
								with VerticalScroll(classes="container_t1"):
									yield Button("Manual combine", id="ManualCombine")
									yield Button("Manual compress", id="ManualCompress")
									yield Button("Manual channel remove", id="ManualRemove")
